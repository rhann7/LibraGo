                    ...
                    <DialogContent>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid gap-2">
                                ...
                                <Input id="password" type="password" ref={passwordInput} placeholder="Password" autoComplete="current-password" value={data.password} onChange={e => setData('password', e.target.value)} />
